...
3. Install [**megaAVR_Slow_PWM** library](https://platformio.org/lib/show/xxxxx/megaAVR_Slow_PWM) by using [Library Manager](https://platformio.org/lib/show/xxxxx/megaAVR_Slow_PWM/installation). Search for **megaAVR_Slow_PWM** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
